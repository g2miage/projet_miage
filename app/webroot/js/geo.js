...
function erreurGeo(error) {
	document.getElementById("maposition").innerHTML = '<div  class="alert alert-block alert-error"><button type="button" class="close" data-dismiss="alert">&times;</button><h4>Oh non !</h4> Le plan n\'est pas affiché car vous n\'avez pas autorisé la géolocalisation :(</div>';
